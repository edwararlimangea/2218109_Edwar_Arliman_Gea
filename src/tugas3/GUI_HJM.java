    ...
    private void Btn_tampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_tampilActionPerformed
        ...
        switch (Cmb_Tipe.getSelectedIndex()) {
            case 0:
                ...
                Motor1.DataMerk(txtmerk.getText());
                Motor1.DataModel(txtmodel.getText());
                Motor1.DataTahunProduksi(Integer.parseInt(txtproduksi.getText()));
                Motor1.DataJumlahStok(Integer.parseInt(txtstok.getText()));
                memo_hasil.setText("");
                memo_hasil.append("Data Sepada Motor"+"\n");
                memo_hasil.append("Merk : "+Motor1.printMerk()+"\n");
                memo_hasil.append("Model : "+Motor1.printModel()+"\n");
                memo_hasil.append("Jumlah Stok : "+Motor1.printJumlahStok()+"\n");
                memo_hasil.append("Tahun Produksi : "+Motor1.printTahunProduksi()+"\n");
                memo_hasil.append("Tipe : "+Motor1.Tipe1);
                break;
            case 1:
                Tipe Motor2 = new Tipe();
                Motor2.DataMerk(txtmerk.getText());
                Motor2.DataModel(txtmodel.getText());
                Motor2.DataTahunProduksi(Integer.parseInt(txtproduksi.getText()));
                Motor2.DataJumlahStok(Integer.parseInt(txtstok.getText()));
                memo_hasil.setText("");
                memo_hasil.append("Data Sepada Motor"+"\n");
                memo_hasil.append("Merk : "+Motor2.printMerk()+"\n");
                memo_hasil.append("Model : "+Motor2.printModel()+"\n");
                memo_hasil.append("Jumlah Stok : "+Motor2.printJumlahStok()+"\n");
                memo_hasil.append("Tahun Produksi : "+Motor2.printTahunProduksi()+"\n");
                memo_hasil.append("Tipe : "+Motor2.Tipe2);
            case 2:
                Tipe Motor3 = new Tipe();
                Motor3.DataMerk(txtmerk.getText());
                Motor3.DataModel(txtmodel.getText());
                //Motor2.DataModel(txtmodel.getText())Motor2;
                Motor3.DataTahunProduksi(Integer.parseInt(txtproduksi.getText()));
                Motor3.DataJumlahStok(Integer.parseInt(txtstok.getText()));
                memo_hasil.setText("");
                memo_hasil.append("Data Sepada Motor"+"\n");
                memo_hasil.append("Merk : "+Motor3.printMerk()+"\n");
                memo_hasil.append("Model : "+Motor3.printModel()+"\n");
                memo_hasil.append("Jumlah Stok : "+Motor3.printJumlahStok()+"\n");
                memo_hasil.append("Tahun Produksi : "+Motor3.printTahunProduksi()+"\n");
                memo_hasil.append("Tipe : "+Motor3.Tipe3);
            default:
                break;
        }
