...
public class GUI_Stok extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Stok stok = new Stok();
        memo_hasil.setText("");
        stok.DataModel(txtmodel.getText());
        try {
            ...
            if (tanggal >= 1 && tanggal <= 6) {
                String sisabarang = stok.getStok("Stok1");
                tampilkanHasil(stok.printModel(),tanggal, bulan, tahun, sisabarang);
            } else if (tanggal >= 7 && tanggal <= 12) {
                String sisabarang = stok.getStok("Stok2");
                tampilkanHasil(stok.printModel(), tanggal, bulan, tahun, sisabarang);
            } else if (tanggal >= 13 && tanggal <= 18) {
                String sisabarang = stok.getStok("Stok3");
                tampilkanHasil(stok.printModel(), tanggal, bulan, tahun, sisabarang);
            } else if (tanggal >= 19 && tanggal <= 24) {
                String sisabarang = stok.getStok("Stok4");
                tampilkanHasil(stok.printModel(), tanggal, bulan, tahun, sisabarang);
            } else if (tanggal >= 25 && tanggal <= 31) {
                String sisabarang = stok.getStok("Stok5");
                tampilkanHasil(stok.printModel(), tanggal, bulan, tahun, sisabarang);
            } else {
