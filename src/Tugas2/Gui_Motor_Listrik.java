 ...
 */
public class Gui_Motor_Listrik extends javax.swing.JFrame {

    /**
     * Creates new form Iventory_Motor_Listrik
     */
    public Gui_Motor_Listrik() {
        initComponents(); // Memanggil fungsi untuk menginisialisasi komponen GUI
        String merk = "HONDA"; // // Mendefinisikan variabel 'merk' dan menginisialisasinya dengan string "HONDA"
        txtmerk.setText(merk); // // Mengatur teks pada komponen 'txtmerk' menjadi nilai yang ada dalam variabel 'merk'
        txtmerk.setEnabled(false); // // Mengatur teks pada komponen 'txtmerk' menjadi nilai yang ada dalam variabel 'merk'
    }
    ...
    private void initComponents() {
        ...
        radiobtnm8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radiobtnm8ActionPerformed(evt);
            }
        });
    ...
    private void btncetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetakActionPerformed
        ...
        String model = radiobtnvgo.isSelected() ? radiobtnvgo.getText() : radiobtnm8.getText();
        int tahunProduksi = Integer.parseInt(txtproduksi.getText()); 
        int harga = Integer.parseInt(txtharga.getText());
        int jumlahStok = Integer.parseInt(txtstok.getText()); 

        constructor_Inventory Listrik = new constructor_Inventory(model, tahunProduksi, harga, jumlahStok);
    ...
    private void radiobtnvgoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radiobtnvgoActionPerformed
        // TODO add your handling code here:
        txtproduksi.setText("2022");
        txtstok.setText("10"); 
        txtharga.setText("50000000");
    ...
    private void radiobtnm8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radiobtnm8ActionPerformed
        // TODO add your handling code here:
        txtproduksi.setText("2022");
        txtstok.setText("15");
        txtharga.setText("60000000");
    }//GEN-LAST:event_radiobtnm8ActionPerformed
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gui_Motor_Listrik.class  
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gui_Motor_Listrik().setVisible(true);
            }
        });
    }
